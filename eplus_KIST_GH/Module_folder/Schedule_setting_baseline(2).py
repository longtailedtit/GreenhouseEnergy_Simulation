...
"""
* (Scenario 2) 작물 정상 생육 온도를 기반으로 한 setpoint 적용(Ideal)
"""
...
def month_schedule_setpoints(mon, sunrise, sunset): # 각 월별 setpoint와 시간대 구간을 설정하는 함수
    ...
    setpoint_data = {
          1: [['13.5','16.5','16.5','13.5','13.5'],['0','1','0'],['87.3','87.5','85.5','80.0','86.5','88.6','87.3'],['18.5','27.5','27.5','18.5','18.5'],['1']],
          2: [['13.5','16.5','16.5','13.5','13.5'],['0','1','0'],['87.3','87.5','85.5','80.0','86.5','88.6','87.3'],['18.5','27.5','27.5','18.5','18.5'],['1']],
          3: [['15.5','21.0','21.0','15.5','15.5'],['0','1','0'],['88.6','89.6','81.0','68.7','78.7','85.3','88.6'],['21.4','30.0','30.0','21.4','21.4'],['1']],
          4: [['15.5','21.0','21.0','15.5','15.5'],['0','1','0'],['88.6','89.6','81.0','68.7','78.7','85.3','88.6'],['21.4','30.0','30.0','21.4','21.4'],['1']],
          5: [['15.5','21.0','21.0','15.5','15.5'],['0','1','0'],['88.6','89.6','81.0','68.7','78.7','85.3','88.6'],['21.4','30.0','30.0','21.4','21.4'],['1']],
          6: [['15.5','21.0','21.0','15.5','15.5'],['0','1','0'],['90.6','92.5','80.4','67.1','75.8','85.3','90.6'],['21.4','30.0','30.0','21.4','21.4'],['1']],
    }
    times_data = {
          1: [[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-1),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),'24:00'],[sunrise,sunset,'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-1),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),'24:00'],['24:00']],
          2: [[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-1),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),'24:00'],[sunrise,sunset,'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-1),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),'24:00'],['24:00']],
          3: [[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-1),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),'24:00'],[sunrise,sunset,'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-1),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),'24:00'],['24:00']],
          4: [[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-1),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),'24:00'],[sunrise,sunset,'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-1),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),'24:00'],['24:00']],
          5: [[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-1),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),'24:00'],[sunrise,sunset,'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-1),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),'24:00'],['24:00']],
          6: [[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-1),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),'24:00'],[sunrise,sunset,'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-1),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),'24:00'],['24:00']],
    }

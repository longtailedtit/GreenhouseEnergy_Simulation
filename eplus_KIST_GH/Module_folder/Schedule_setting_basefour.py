...
"""
* 작물 정상 생육 온도를 기반으로 한 setpoint 적용
* 2단계 -> 4단계로 나눔
"""
...
def month_schedule_setpoints(mon, sunrise, sunset): # 각 월별 setpoint와 시간대 구간을 설정하는 함수
    ...
    setpoint_data = {
          1: [['14.0','15.8','15.8','17.5','17.5','13.0','13.0','14.0','14.0'],['0','1','0'],['87.3','87.5','85.5','80.0','86.5','88.6','87.3'],['19.0','23.5','23.5','27.5','27.5','18.0','18.0','19.0','19.0'],['1']],
          2: [['14.0','15.8','15.8','17.5','17.5','13.0','13.0','14.0','14.0'],['0','1','0'],['87.3','87.5','85.5','80.0','86.5','88.6','87.3'],['19.0','23.5','23.5','27.5','27.5','18.0','18.0','19.0','19.0'],['1']],
          3: [['16.0','18.5','18.5','22.0','22.0','15.0','15.0','16.0','16.0'],['0','1','0'],['88.6','89.6','81.0','68.7','78.7','85.3','88.6'],['22.0','26.7','26.7','30.0','30.0','20.4','20.4','22.0','22.0'],['1']],
          4: [['16.0','18.5','18.5','22.0','22.0','15.0','15.0','16.0','16.0'],['0','1','0'],['88.6','89.6','81.0','68.7','78.7','85.3','88.6'],['22.0','26.7','26.7','30.0','30.0','20.4','20.4','22.0','22.0'],['1']],
          5: [['16.0','18.5','18.5','22.0','22.0','15.0','15.0','16.0','16.0'],['0','1','0'],['88.6','89.6','81.0','68.7','78.7','85.3','88.6'],['22.0','26.7','26.7','30.0','30.0','20.4','20.4','22.0','22.0'],['1']],
          6: [['16.0','18.5','18.5','22.0','22.0','15.0','15.0','16.0','16.0'],['0','1','0'],['90.6','92.5','80.4','67.1','75.8','85.3','90.6'],['22.0','26.7','26.7','30.0','30.0','20.4','20.4','22.0','22.0'],['1']],
    }
    times_data = {
          1: [[CalculateDatetime(sunrise,2),sunrise,CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-3),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),CalculateDatetime(sunset,-3),CalculateDatetime(sunset,-4),'24:00']
              ,[sunrise,sunset,'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-3),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),CalculateDatetime(sunset,-3),CalculateDatetime(sunset,-4),'24:00']
              ,['24:00']],
          2: [[CalculateDatetime(sunrise,2),sunrise,CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-3),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),CalculateDatetime(sunset,-3),CalculateDatetime(sunset,-4),'24:00']
              ,[sunrise,sunset,'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-3),CalculateDatetime(sunset,1),CalculateDatetime(sunset,-2),CalculateDatetime(sunset,-3),CalculateDatetime(sunset,-4),'24:00']
              ,['24:00']],
          3: [[CalculateDatetime(sunrise,2),sunrise,CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-3),CalculateDatetime(sunset,2),CalculateDatetime(sunset,-1),CalculateDatetime(sunset,-2),CalculateDatetime(sunset,-3),'24:00']
              ,[sunrise,sunset,'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-3),CalculateDatetime(sunset,2),CalculateDatetime(sunset,-1),CalculateDatetime(sunset,-2),CalculateDatetime(sunset,-3),'24:00']
              ,['24:00']],
          4: [[CalculateDatetime(sunrise,2),sunrise,CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-3),CalculateDatetime(sunset,2),CalculateDatetime(sunset,-1),CalculateDatetime(sunset,-2),CalculateDatetime(sunset,-3),'24:00']
              ,[sunrise,sunset,'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-3),CalculateDatetime(sunset,2),CalculateDatetime(sunset,-1),CalculateDatetime(sunset,-2),CalculateDatetime(sunset,-3),'24:00']
              ,['24:00']],
          5: [[CalculateDatetime(sunrise,2),sunrise,CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-3),CalculateDatetime(sunset,2),CalculateDatetime(sunset,-1),CalculateDatetime(sunset,-2),CalculateDatetime(sunset,-3),'24:00']
              ,[sunrise,sunset,'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-3),CalculateDatetime(sunset,2),CalculateDatetime(sunset,-1),CalculateDatetime(sunset,-2),CalculateDatetime(sunset,-3),'24:00']
              ,['24:00']],
          6: [[CalculateDatetime(sunrise,2),sunrise,CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-3),CalculateDatetime(sunset,2),CalculateDatetime(sunset,-1),CalculateDatetime(sunset,-2),CalculateDatetime(sunset,-3),'24:00']
              ,[sunrise,sunset,'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-3),CalculateDatetime(sunset,2),CalculateDatetime(sunset,-1),CalculateDatetime(sunset,-2),CalculateDatetime(sunset,-3),'24:00']
              ,['24:00']],

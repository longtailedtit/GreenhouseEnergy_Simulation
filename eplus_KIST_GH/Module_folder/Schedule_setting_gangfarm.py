...
"""
* 토마토 농가 데이터(강원도 평창)를 참고하여 설정한 setpoint
"""
...
def month_schedule_setpoints(mon, sunrise, sunset): # 각 월별 setpoint와 시간대 구간을 설정하는 함수
    ...
    setpoint_data = {
          1: [['18.0','20.3','20.3','22.5','22.5','19.4','19.4','18.0','18.0'],['0','1','0'],['87.3','87.5','85.5','80.0','86.5','88.6','87.3'],['22.5','25.3','25.3','28.5','28.5','24.8','24.8','22.5','22.5'],['1']],
          2: [['18.0','20.3','20.3','22.5','22.5','19.4','19.4','18.0','18.0'],['0','1','0'],['87.3','87.5','85.5','80.0','86.5','88.6','87.3'],['22.5','25.3','25.3','28.5','28.5','24.8','24.8','22.5','22.5'],['1']],
          3: [['19.2','21.2','21.2','23.5','23.5','19.7','19.7','19.2','19.2'],['0','1','0'],['88.6','89.6','81.0','68.7','78.7','85.3','88.6'],['24.1','26.9','26.9','29.5','29.5','25.3','25.3','24.1','24.1'],['1']],
          4: [['19.2','21.2','21.2','23.5','23.5','19.7','19.7','19.2','19.2'],['0','1','0'],['88.6','89.6','81.0','68.7','78.7','85.3','88.6'],['24.1','26.9','26.9','29.5','29.5','25.3','25.3','24.1','24.1'],['1']],
          5: [['18.8','21.3','21.3','23.8','23.8','20.6','20.6','18.8','18.8'],['0','1','0'],['88.6','89.6','81.0','68.7','78.7','85.3','88.6'],['23.3','26.4','26.4','29.8','29.8','25.6','25.6','23.3','23.3'],['1']],
          6: [['18.8','21.3','21.3','23.8','23.8','20.6','20.6','18.8','18.8'],['0','1','0'],['90.6','92.5','80.4','67.1','75.8','85.3','90.6'],['23.3','26.4','26.4','29.8','29.8','25.6','25.6','23.3','23.3'],['1']],
    }
    times_data = {

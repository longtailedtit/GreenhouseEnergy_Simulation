...
"""
전력량 데이터를 위한 별도의 검증. 1월 12일~3월 31일.
+ 4월 전체(1-11,12-20,21-30)
"""
...
#        line=data[178]
        ...
        # 거의 열리지 않는 시간대(1월~3월11일까지)는 5,15로 설정해서 왠만하면 거의 천창이 열리지 않게 함
...
def month_schedule_setpoints(mon, sunrise, sunset): # 각 월별 setpoint와 시간대 구간을 설정하는 함수
    ...
    setpoint_data = {
          1: [['0.0','0.0','19.0','10.0','10.0','1.0','0.0'],['0','1','0'],['87.3','87.5','85.5','80.0','86.5','88.6','87.3'],['18.0','25.0','27.0','26.0','24.0','18.0','18.0'],['0']],
          2: [['0.0','1.0','5.0','5.0','5.0','5.0','2.0','0.0'],['0','1','0'],['87.3','87.5','85.5','80.0','86.5','88.6','87.3'],['18.0','25.0','27.0','28.0','27.0','24.0','19.0','18.0'],['0']],
          3: [['0.0','1.0','5.0','5.0','5.0','5.0','2.0','0.0'],['0','1','0'],['88.6','89.6','81.0','68.7','78.7','85.3','88.6'],['18.0','25.0','27.0','28.0','27.0','24.0','19.0','18.0'],['0']],
          4: [['14.0','14.0','21.0','21.0','14.0','14.0','14.0'],['0','1','0'],['88.6','89.6','81.0','68.7','78.7','85.3','88.6'],['16.0','31.0','31.0','31.0','22.0','16.0','16.0'],['0']],
    ...
    times_data = {
          1: [[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-2),'13:30',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-1.5),'24:00'],['09:00','09:10','15:30','15:40','24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,2),CalculateDatetime(sunrise,-2),'13:30',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-1.5),'24:00'],['24:00']],
          2: [[CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-2.5),'11:30','13:00',CalculateDatetime(sunset,2),CalculateDatetime(sunset,-1.5),'24:00'],['09:00','09:10','15:30','15:40','24:00']
              ,[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-2.5),'11:30','13:00',CalculateDatetime(sunset,2),CalculateDatetime(sunset,-1.5),'24:00'],['24:00']],
          3: [[CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-2.5),'11:30','13:00',CalculateDatetime(sunset,2),CalculateDatetime(sunset,-1.5),'24:00']
              ,['09:00','09:10','15:30','15:40','24:00'],[CalculateDatetime(sunrise,2),sunrise,'12:00',CalculateDatetime(sunset,2),sunset,CalculateDatetime(sunset,-2),'24:00']
              ,[CalculateDatetime(sunrise,-1),CalculateDatetime(sunrise,-2.5),'11:30','13:00',CalculateDatetime(sunset,2),CalculateDatetime(sunset,-1.5),'24:00'],['24:00']],
          4: [[CalculateDatetime(sunrise,0.5),'10:00','11:30',CalculateDatetime(sunset,1.5),sunset,CalculateDatetime(sunset,-1.5),'24:00']
              ...
              ,[CalculateDatetime(sunrise,0.5),'10:00','11:30',CalculateDatetime(sunset,1.5),sunset,CalculateDatetime(sunset,-1.5),'24:00'],['24:00']],
